<script setup>
 useHead({
   title: 'FPS-Terms & Conditions',
   meta: [
     { name: 'description', content: `Your Ultimate Online Coin Toss Tool! Make quick and fair decisions with our virtual coin flip. Heads or tails, it's all in your hands. Flip a digital coin with just a click!` }
   ],
   htmlAttrs: {
       lang: 'en'
     }
...
<template>
    <div class="text-slate-950 dark:bg-[#121212] dark:text-slate-300 bg-white">

        <div class="max-w-screen-lg items-center m-auto p-3 leading-7">
    
        <h2 class="text-center text-6xl font-semibold text-[#236c7e] my-5 font-Amaranth">TERMS AND CONDITIONS</h2>


        <div class="lg:prose-lg prose-h2:text-2xl prose-p:text-base prose-p:leading-7 prose-li:text-base prose-li:list-disc prose-th:py-4 prose-thead:border-t  prose-thead:border-[#db0000] prose-tr:border-b prose-tr:border-[#db0000]">
        ...
        <ul>
            ...
            <li><span>Country</span> refers to: California, United States</li>    
            <li><span>Company</span> (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to coin flipper.</li>   
            ...
            <li><span>Website</span> refers to Coin Flipper, accessible from <span>https://Coinflipper.com</span></li>
        ...
        <ul>
            <li>By email <span>support@Coinflipper.com</span></li>
            <li>By visiting this page on our website <span><NuxtLink to="/contact">Contact Us</NuxtLink></span></li>
        </ul>
